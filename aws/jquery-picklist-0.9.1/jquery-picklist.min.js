...
a.element.children().each(function(){var b=c(this).text(),b=c("<li/>").text(b).attr("label",b).attr(a.options.listItemValueAttribute,c(this).val()).addClass(a.options.listItemClass);"selected"==c(this).attr("selected")?a.targetList.append(b):a.sourceList.append(b)});a.insertItems(a.options.items);a._trigger("afterPopulate")},_addAllHandler:function(a){var b=a.data.pickList;b._trigger("beforeAddAll");a=b.sourceList.children();b.targetList.append(b._removeSelections(a));a.each(function(){b.element.children("[value='"+
b._getItemValue(this)+"']").attr("selected","selected")});b._refresh();b._trigger("afterAddAll")},_addHandler:function(a){var b=a.data.pickList;b._trigger("beforeAdd");a=b.sourceList.children(".ui-selected");b.targetList.append(b._removeSelections(a));a.each(function(){b.element.children("[value='"+b._getItemValue(this)+"']").attr("selected","selected")});b._refresh();b._trigger("afterAdd")},_removeHandler:function(a){var b=a.data.pickList;b._trigger("beforeRemove");a=b.targetList.children(".ui-selected");
b.sourceList.append(b._removeSelections(a));a.each(function(){b.element.children("[value='"+b._getItemValue(this)+"']").removeAttr("selected")});b._refresh();b._trigger("afterRemove")},_removeAllHandler:function(a){var b=a.data.pickList;b._trigger("beforeRemoveAll");a=b.targetList.children();b.sourceList.append(b._removeSelections(a));a.each(function(){b.element.children("[value='"+b._getItemValue(this)+"']").removeAttr("selected")});b._refresh();b._trigger("afterRemoveAll")},_refresh:function(){this._trigger("beforeRefresh");
this._refreshControls();this.options.sortItems&&(this._sortItems(this.sourceList,this.options),this._sortItems(this.targetList,this.options));this._trigger("afterRefresh")},_refreshControls:function(){this._trigger("beforeRefreshControls");this.sourceList.children().length?this.addAllButton.removeAttr("disabled"):this.addAllButton.attr("disabled","disabled");this.targetList.children().length?this.removeAllButton.removeAttr("disabled"):this.removeAllButton.attr("disabled","disabled");this.sourceList.children(".ui-selected").length?
this.addButton.removeAttr("disabled"):this.addButton.attr("disabled","disabled");this.targetList.children(".ui-selected").length?this.removeButton.removeAttr("disabled"):this.removeButton.attr("disabled","disabled");this._trigger("afterRefreshControls")},_sortItems:function(a,b){var d=[];a.children().each(function(){d.push(c(this))});d.sort(function(a,c){return a.attr(b.sortAttribute)>c.attr(b.sortAttribute)?1:a.attr(b.sortAttribute)==c.attr(b.sortAttribute)?0:-1});a.empty();for(var e=0;e<d.length;e++)a.append(d[e])},
_changeHandler:function(a){var b=a.data.pickList;if(a.ctrlKey)b._isSelected(c(this))?b._removeSelection(c(this)):(b.lastSelectedItem=c(this),b._addSelection(c(this)));else if(a.shiftKey){var d=b._getItemValue(this),e=b._getItemValue(b.lastSelectedItem);c(this).index()<c(b.lastSelectedItem).index()&&(a=d,d=e,e=a);var f=!1,g=!0;b._clearSelections(c(this).parent());c(this).parent().children().each(function(){b._getItemValue(this)==e&&(f=true);f&&g&&b._addSelection(c(this));b._getItemValue(this)==d&&
(g=false)})}else b.lastSelectedItem=c(this),b._clearSelections(c(this).parent()),b._addSelection(c(this));b._refreshControls()},_isSelected:function(a){return a.hasClass("ui-selected")},_addSelection:function(a){return a.addClass("ui-selected").addClass("ui-state-highlight").addClass(this.options.selectedListItemClass)},_removeSelection:function(a){return a.removeClass("ui-selected").removeClass("ui-state-highlight").removeClass(this.options.selectedListItemClass)},_removeSelections:function(a){var b=
this;a.each(function(){c(this).removeClass("ui-selected").removeClass("ui-state-highlight").removeClass(b.options.selectedListItemClass)});return a},_clearSelections:function(a){var b=this;a.children().each(function(){b._removeSelection(c(this))})},_setOption:function(a,b){c.Widget.prototype._setOption.apply(this,arguments)},destroy:function(){this._trigger("onDestroy");this.pickList.remove();this.element.show();c.Widget.prototype.destroy.call(this)},insert:function(a){var b=a.selected?this.targetList:
this.sourceList,c=this._createSelectItem(a),a=void 0==a.element?this._createRegularItem(a):this._createRichItem(a);this.element.append(c);b.append(a);this._refresh()},insertItems:function(a){var b=this,d=[],e=[],f=[];c(a).each(function(){var a=b._createSelectItem(this),c=void 0==this.element?b._createRegularItem(this):b._createRichItem(this);d.push(a);this.selected?f.push(c):e.push(c)});b.element.append(d.join("\n"));b.sourceList.append(e.join("\n"));b.targetList.append(f.join("\n"))},_createSelectItem:function(a){return"<option value='"+
a.value+"'"+(a.selected?" selected='selected'":"")+">"+a.label+"</option>"},_createRegularItem:function(a){return"<li "+this.options.listItemValueAttribute+"='"+a.value+"' label='"+a.label+"' class='"+this.options.listItemClass+"'>"+a.label+"</li>"},_createRichItem:function(a){var b=a.element.clone().wrap("<div>").parent().html();a.element.hide();return"<li "+this.options.listItemValueAttribute+"='"+a.value+"' label='"+a.label+"' class='"+this.options.listItemClass+" "+this.options.richListItemClass+
"'>"+b+"</li>"},_getItemValue:function(a){return c(a).attr(this.options.listItemValueAttribute)}})})(jQuery);